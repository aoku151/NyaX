        ...
        try {
            ...
            profileHeader.innerHTML = `
                ...
                <div class="profile-info">
                    ...
                    <div class="user-id">#${user.id} ${user.settings.show_scid ? `(<a href="https://scratch.mit.edu/users/${user.scid}" class="scidlink" targer="_blank" rel="nopener noreferrer" onclick="event.stopPropagation()">@${user.scid}</a>)` : ''}</div>
